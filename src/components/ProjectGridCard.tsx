...
export default function ProjectGridCard({
  ...
  // Tile previews are light/white UI screenshots — flip the fixed nav to
  // its light variant whenever one of these scrolls under it.
  ...
  const card = (
    <div
      ...
      className={`group relative w-full overflow-hidden rounded-3xl ring-1 ring-white/10 ${
    ...
    >
      {video ? (
        ...
        // animated .webp — plain <img>, not next/image, so the optimizer doesn't flatten it to one frame
